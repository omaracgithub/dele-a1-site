# DELE A1 Marketing Site

Static marketing website for the DELE A1 Practice iOS app.

**Live at:** https://a1.prepdele.com
...
3. Add custom domain `a1.prepdele.com`
4. Add a CNAME DNS record pointing `a1.prepdele.com` to `omaracgithub.github.io`
